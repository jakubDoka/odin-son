...
when !SPEC_NOT_PRESENT {
	@(rodata)
	NODE_TO_LANE_OP := #partial [Node_Type][bac.Lane_Type]Opcode_FD {
		.Add = #partial{
			.I8 = .I8x16_Add,
			.I16 = .I16x8_Add,
			.I32 = .I32x4_Add,
	...
	@(rodata)
	NODE_TO_OP := #partial [Node_Type][bac.Node_Datatype]Opcode {
...
@(rodata)
DT_TO_VALTYPE := #partial [bac.Node_Datatype]Type {
	.I8 ..= .I32      = .i32,
	.I64  = .i64,
	.F64  = .f64,
	.F32  = .f32,
