...
Un_Op :: enum u16 {
	F_To_I = u16(backend.Ideal_Node_Type.F_To_I),
	Cast = u16(backend.Ideal_Node_Type.Cast),
	F_Ext = u16(backend.Ideal_Node_Type.F_Ext),
	F_From_I = u16(backend.Ideal_Node_Type.F_From_I),
	Not = u16(backend.Ideal_Node_Type.Not),
	Neg = u16(backend.Ideal_Node_Type.Neg),
	Uext = u16(backend.Ideal_Node_Type.Uext),
	Sext = u16(backend.Ideal_Node_Type.Sext),
	F_Demote = u16(backend.Ideal_Node_Type.F_Demote),
}
Bin_Op :: enum u16 {
	Add = u16(backend.Ideal_Node_Type.Add),
	Rem = u16(backend.Ideal_Node_Type.Rem),
	And = u16(backend.Ideal_Node_Type.And),
	And_Not = u16(backend.Ideal_Node_Type.And_Not),
	U_Shr = u16(backend.Ideal_Node_Type.U_Shr),
	Div = u16(backend.Ideal_Node_Type.Div),
	Lt = u16(backend.Ideal_Node_Type.Lt),
	Ge = u16(backend.Ideal_Node_Type.Ge),
	Xor = u16(backend.Ideal_Node_Type.Xor),
	Ne = u16(backend.Ideal_Node_Type.Ne),
	F_Sub = u16(backend.Ideal_Node_Type.F_Sub),
	F_Div = u16(backend.Ideal_Node_Type.F_Div),
	U_Gt = u16(backend.Ideal_Node_Type.U_Gt),
	U_Ge = u16(backend.Ideal_Node_Type.U_Ge),
	F_Ge = u16(backend.Ideal_Node_Type.F_Ge),
	Shr = u16(backend.Ideal_Node_Type.Shr),
	F_Ne = u16(backend.Ideal_Node_Type.F_Ne),
	F_Le = u16(backend.Ideal_Node_Type.F_Le),
	U_Rem = u16(backend.Ideal_Node_Type.U_Rem),
	Sub = u16(backend.Ideal_Node_Type.Sub),
	Mul = u16(backend.Ideal_Node_Type.Mul),
	U_Div = u16(backend.Ideal_Node_Type.U_Div),
	Le = u16(backend.Ideal_Node_Type.Le),
	Gt = u16(backend.Ideal_Node_Type.Gt),
	Or = u16(backend.Ideal_Node_Type.Or),
	Eq = u16(backend.Ideal_Node_Type.Eq),
	F_Add = u16(backend.Ideal_Node_Type.F_Add),
	F_Mul = u16(backend.Ideal_Node_Type.F_Mul),
	U_Lt = u16(backend.Ideal_Node_Type.U_Lt),
	U_Le = u16(backend.Ideal_Node_Type.U_Le),
	F_Gt = u16(backend.Ideal_Node_Type.F_Gt),
	Shl = u16(backend.Ideal_Node_Type.Shl),
	F_Eq = u16(backend.Ideal_Node_Type.F_Eq),
	F_Lt = u16(backend.Ideal_Node_Type.F_Lt),
}
