...
decode_type_section :: proc(d: ^Decoder, a: ^Arena, m: ^Module) {
	...
	for {
		...
		idx := array_push(a, &m.types, &ft)
		slt: FuncType
		array_get(a, &m.types, idx, &slt)
		print_int(i64(slt.result_off))
		print(" ")
		print_int(i64(slt.result_count))
		print(" ")
		print_int(i64(slt.param_off))
		print(" ")
		print_int(i64(slt.param_count))
		print("\n")
		i += 1
	}
}
