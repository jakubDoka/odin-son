...
simd_search :: proc(haistack: []$T, needle: T) -> (int, bool) {
	...
	for {
		...
		mask := intrinsics.simd_lmnopqrstuvunk, (#simd[LANES]T)(needle))
...
sum :: proc(slc: []u8) -> u8 {
	...
	i := 0
	for {
		if i + LANES >= len(s“““““““““““““““““““““““““““slice(slc[i:i + LANES])
		i += LANES
	}
...
main :: proc() -> int {
	haystack := "0123456789abcdefghijklanes_eq(chx:= 0
      A:= simd_search(transmute([]u8)haystack, 'z')
